...
// Cost returns the patch's cost with all adjusted fields rounded to remove floating-point noise.
...
// PredictedCost returns the patch's predicted cost with all adjusted fields rounded to remove floating-point noise.
